...
const Footer = () => {
  return (
    <footer className="px-2 sm:px-4 py-2.5 w-full dark:bg-backgroundColor-primary bg-white">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <Link
          href={config.appUrl}
          className="mx-auto text-gray-400 text-sm font-semibold whitespace-nowrap dark:text-white"
        >
          2023 copyright {config.appName}
        </Link>
